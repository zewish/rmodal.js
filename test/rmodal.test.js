...
describe('RModal', function () {
  ...
  describe('constructor()', function () {
    ...
    it('should have versions defined in both instance and static', function () {
      var instance = create();

      expect(instance.version).to.be.a('string');
      expect(RModal.version).to.be.a('string');
    });
  });
  ...
  describe('_doOpen()', function () {
    ...
    it('should call "this.focus()"', function () {
      var instance = create();
  ...
  describe('_doClose()', function () {
    it('does not break when "this.opts.dialogOpenClass" is empty', function () {
      var instance = create({
        dialogOpenClass: null
      });
  ...
  describe('focus()', function () {
    it('breaks when this.opts.foucsElement is not set', function () {
      var instance = create();
      instance.opts.focusElements = null;
      expect(function () {
        instance.focus()
      }).to.throw();
    });
  ...
  describe('keydown()', function () {
    ...
    it('should break when this.opts.focusElement is missing', function () {
      var instance = create();
    ...
    it('should call "stopEvent()"', function () {
      var stub = sinon.stub(RModal.prototype, 'elements').returns(
        [ '1', '1' ]
      );
